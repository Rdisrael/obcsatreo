...
//528636/1341211/2.50/3/3/Transistor BJT NPN
...
(library Library_1
	...
	(symbolDef "FMMT619TA" (originalName "FMMT619TA")
	...
	(compDef "FMMT619TA" (originalName "FMMT619TA") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FMMT619TA"))
		...
		(attr "Mouser Part Number" "522-FMMT619TA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/FMMT619TA?qs=Ly%2FNF0nuwQ%2FpsAMUAUdYFg%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "FMMT619TA")
		(attr "Description" "Diodes Inc FMMT619TA NPN Bipolar Transistor, 2 A, 50 V, 3-Pin SOT-23")
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/FMMT619.pdf")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "FMMT619TA.stp")
